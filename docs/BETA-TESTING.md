...
版本：0.4.2-beta.1。适用场景：每人一台 Mac，在不同网络里共享同一个 Agent 会话。

## 1. 安装

- Apple Silicon（M 系列）：[直接下载](https://github.com/ebrahimeolakey/ready-player-one/releases/download/v0.4.2-beta.1/Ready-Player-One-0.4.2-beta.1-mac-arm64.zip)。
- Intel Mac：[直接下载](https://github.com/ebrahimeolakey/ready-player-one/releases/download/v0.4.2-beta.1/Ready-Player-One-0.4.2-beta.1-mac-x64.zip)。
